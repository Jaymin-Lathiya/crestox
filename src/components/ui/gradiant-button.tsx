...
type ColorVariant = "emerald" | "purple" | "orange" | "primary";
...
const gradientColors: Record<ColorVariant, GradientColors> = {
    ...
    primary: {
        dark: {
            border: "from-[#2563EB] via-[#0C1F21] to-[#1E40AF]",
            overlay: "from-[#3B82F6]/40 via-[#0C1F21] to-[#1E3A8A]/30",
            accent: "from-[#60A5FA]/10 via-[#0C1F21] to-[#1E3A8A]/50",
            text: "from-[#60A5FA] to-[#93C5FD]",
            glow: "rgba(37, 99, 235, 0.1)",
            textGlow: "rgba(37, 99, 235, 0.4)",
        ...
        light: {
            ...
            overlay: "from-blue-400/30 via-blue-300/20 to-blue-500/20",
            accent: "from-blue-500/20 via-blue-400/10 to-blue-300/30",
            text: "from-blue-700 to-blue-600",
            glow: "rgba(37, 99, 235, 0.2)",
            hover: "from-blue-400/30 via-blue-300/20 to-blue-400/30",
        },
    },
};
